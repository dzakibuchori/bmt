        ...
        <div class="panel-body">
            <div class="col-md-2">
                <a href="<?php echo base_url('Nasabah/tambah'); ?>">
                    <button class="form-control btn btn-success">
                        <i class="glyphicon glyphicon-plus-sign"></i> Tambah Nasabah
                    </button>
                </a>
            </div>
            ...
            <div class="col-md-2">
                <button class="form-control btn btn-success" data-toggle="modal" data-target="#import-nasabah">
                    <i class="glyphicon glyphicon-plus-sign"></i> Nasabah Kolektif
                </button>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="min-width:180px;">
                            <a href="<?php echo base_url('Nasabah/update'); ?>">
                                <button class="btn btn-warning update-dataNasabah"
                                        data-id="<?php echo $nasabah->nasabah_id; ?>">
                                    <i class="glyphicon glyphicon-repeat"></i> Update
                                </button>
                            </a>
                            <a href="<?php echo base_url('Nasabah/deleteAnggota'); ?>">
                                <button class="btn btn-danger konfirmasiHapus-nasabah"
                                        data-id="<?php echo $nasabah->nasabah_id; ?>">
